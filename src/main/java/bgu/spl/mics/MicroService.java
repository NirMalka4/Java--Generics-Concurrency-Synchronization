...
public abstract class MicroService implements Runnable {
    ...
    // Utility container used for matching each Event instance it's appropriate callback function.
    Map<Class<? extends Message>, Callback> eventCallbackMap;
    // Utility container used for matching each Broadcast instance it's appropriate callback function.
    Map<Class<? extends Message>, Callback> broadcastCallbackMap;
    //Indicate whether Microservice should be terminated
    AtomicBoolean terminate;
    //Key at Attack Event heap
    private AtomicInteger PQ_Key;
    ...
    public MicroService(String name) {
        ...
        broadcastCallbackMap=new HashMap<>();
   ...
   public final void run() {
        ...
        while (!terminate.get()) {
            ...
            if (Event.class.isAssignableFrom(message.getClass()))
                ...
                broadcastCallbackMap.get(message.getClass()).call(message);
        }
        bus.unregister(this);
    }
}
